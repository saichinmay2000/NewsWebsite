...
*/
    ...
    var z = /:[0-9]+$/,
        B = function (a, b) {
            ...
            "port" === b
                ? (a.port = String(Number(a.hostname ? a.port : t.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")))
                : "host" === b && (a.hostname = (a.hostname || t.location.hostname).replace(z, "").toLowerCase());
            var c = A(a.protocol);
            b && (b = String(b).toLowerCase());
            switch (b) {
...
*/
    ...
    var bd = function (a) {
        ...
        ge = function (a, b, c) {
            1 <= 100 * Math.random() ||
                G("?") ||
                ((a = ["t=error", "_e=" + a, "_v=j83", "sr=1"]), b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua));
        };
    var qc = function () {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        ...
        pd = function (a) {
            ...
            if (d && a.get(cc) && (b = M.location.hash)) {
                ...
                d = [];
                for (c = 0; c < b.length; ++c)
                    (D(b[c], "utm_id") || D(b[c], "utm_campaign") || D(b[c], "utm_source") || D(b[c], "utm_medium") || D(b[c], "utm_term") || D(b[c], "utm_content") || D(b[c], "gclid") || D(b[c], "dclid") || D(b[c], "gclsrc")) &&
                        d.push(b[c]);
                    ...
                    if (("https:" == a || a == d || ("http:" != a ? 0 : "http:" == d)) && B(ca)) {
                        if ((ca = ca.url))
                            (a = (a = (M.querySelector && M.querySelector("script[nonce]")) || null) ? a.nonce || (a.getAttribute && a.getAttribute("nonce")) || "" : ""),
                                e
                                    ? ((e = ""), a && Nd.test(a) && (e = ' nonce="' + a + '"'), f.test(ca) && M.write("<script" + e + ' src="' + ca + '">\x3c/script>'))
