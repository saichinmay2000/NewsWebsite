/*! jQuery v1.12.4 | (c) jQuery Foundation | jquery.org/license | WordPress 2019-05-16 */ !(function(a, b) {
    ...
    n.extend({
            ...
            clone: function(a, b, c) {
                ...
                if (
                    (l.html5Clone || n.isXMLDoc(a) || !ta.test("<" + a.nodeName + ">") ? (f = a.cloneNode(!0)) : ((Aa.innerHTML = a.outerHTML), Aa.removeChild((f = Aa.firstChild))), !((l.noCloneEvent && l.noCloneChecked) || (1 !== a.nodeType && 11 !== a.nodeType) || n.isXMLDoc(a)))
                )
                ...
                if (f)
                    return (
                        ...
                        (void 0 !== e.getBoundingClientRect && (d = e.getBoundingClientRect()),
                            (c = lc(f)), { top: d.top + (c.pageYOffset || b.scrollTop) - (b.clientTop || 0), left: d.left + (c.pageXOffset || b.scrollLeft) - (b.clientLeft || 0) }) :
                        d
                    );
            },
            position: function() {
                if (this[0]) {
                    ...
                    return (
                        ...
                        ((a = this.offsetParent()), (b = this.offset()), n.nodeName(a[0], "html") || (c = a.offset()), (c.top += n.css(a[0], "borderTopWidth", !0)), (c.left += n.css(a[0], "borderLeftWidth", !0))), { top: b.top - c.top - n.css(d, "marginTop", !0), left: b.left - c.left - n.css(d, "marginLeft", !0) }
                    );
                }
            },
